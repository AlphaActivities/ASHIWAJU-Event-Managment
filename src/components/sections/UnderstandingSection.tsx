    ...
    >
      <div className="mx-auto w-full max-w-6xl px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <LuxFadeIn delay={0.1}>
            <div className="order-1 lg:order-2 relative overflow-hidden rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.06)] w-full min-h-[360px] md:min-h-[520px] lg:h-full">
              <img
          ...
          <LuxFadeIn delay={0.2}>
            <div className="order-2 lg:order-1 w-full">
              ...
              <p className="mt-8 md:mt-10 text-[15px] md:text-lg leading-relaxed text-[#151515] font-sans">

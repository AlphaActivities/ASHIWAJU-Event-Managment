    ...
    >
      <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-10">
        <LuxFadeIn delay={0.05}>
          <div className="rounded-2xl bg-[#EFE8DA] border border-[#C99524]/15 px-8 py-10 md:px-12 md:py-14 lg:px-16 lg:py-16 text-center shadow-[0_8px_40px_rgba(0,0,0,0.06)]">
            <p className="font-serif text-lg sm:text-2xl lg:text-[1.6rem] leading-[1.5] text-[#151515] tracking-tight">
              This is the first decision you&rsquo;ll make that will determine
            </p>
            <p className="font-serif text-lg sm:text-xl lg:text-[1.3rem] leading-[1.5] text-[#151515]/75 mt-4 lg:mt-5">
              If you will look back years after your wedding with tears of disappointment
            </p>
            <p className="font-serif text-lg sm:text-xl text-[#C99524] my-6 lg:my-8">
              Or
            </p>
            <p className="font-serif text-lg sm:text-xl lg:text-[1.3rem] leading-[1.5] text-[#151515]/75">
